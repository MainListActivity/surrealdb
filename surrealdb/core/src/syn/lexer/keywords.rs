...
pub(crate) static KEYWORDS: phf::Map<UniCase<&'static str>, TokenKind> = phf_map! {
	...
	UniCase::ascii("GENERATION") => TokenKind::Keyword(Keyword::Generation),
	...
	UniCase::ascii("MATCH") => TokenKind::Keyword(Keyword::Match),
	...
	UniCase::ascii("NEEDED") => TokenKind::Keyword(Keyword::Needed),
	...
	UniCase::ascii("QUOTA") => TokenKind::Keyword(Keyword::Quota),
	...
	UniCase::ascii("RULE") => TokenKind::Keyword(Keyword::Rule),
	...
	UniCase::ascii("UNLIMITED") => TokenKind::Keyword(Keyword::Unlimited),
